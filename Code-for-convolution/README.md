...
3. Demo
Instructions to run on data: This file contains two main Matlab codes (Data_encoding.m, Frequency_comb_decoding.m), for data encoding and restoring from experimentally measured frequency comb spectra. Two datasets are provide for testing, "Correction_160.mat" and "r0.mat". The original image is provided, "flower.jpg". The experimental datasets consisting of 10 CSV files are located in the "flower_broad_121" folder.
